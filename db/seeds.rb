...
vote1 = user3.votes.create(choice_id: choice1.id, question_id: question1.id, survey_id: survey1.id)
vote2 = user3.votes.create(choice_id: choice4.id, question_id: question2.id, survey_id: survey2.id)
vote3 = user3.votes.create(choice_id: choice5.id, question_id: question3.id, survey_id: survey3.id)
vote4 = user3.votes.create(choice_id: choice8.id, question_id: question4.id, survey_id: survey4.id)
